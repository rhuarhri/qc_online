...
class BaskRecyclerViewAdapter(private var items : MutableList<Item>, private val itemClicked : (item: Item) -> Unit) : RecyclerView.Adapter<BaskRecyclerViewAdapter.ItemViewHolder>() {
